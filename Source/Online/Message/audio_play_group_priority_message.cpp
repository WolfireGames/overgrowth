...
AudioPlayGroupPriorityMessage::AudioPlayGroupPriorityMessage(const std::string& path, vec3 pos, int priority) : OnlineMessageBase(OnlineMessageCategory::LEVEL_TRANSIENT),
                                                                                                                path(path),
                                                                                                                pos(pos),
                                                                                                                priority(priority) {
}
