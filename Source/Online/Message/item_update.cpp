...
ItemUpdate::ItemUpdate() : OnlineMessageBase(OnlineMessageCategory::LEVEL_TRANSIENT),
                           id(-1),
                           timestamp(0),
                           transform(mat4()) {
}

ItemUpdate::ItemUpdate(ItemObject* object) : OnlineMessageBase(OnlineMessageCategory::LEVEL_TRANSIENT),
