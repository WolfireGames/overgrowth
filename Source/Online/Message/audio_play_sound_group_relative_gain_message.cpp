...
AudioPlaySoundGroupRelativeGainMessage::AudioPlaySoundGroupRelativeGainMessage(const std::string& path, float gain) : OnlineMessageBase(OnlineMessageCategory::LEVEL_TRANSIENT),
                                                                                                                      path(path),
                                                                                                                      gain(gain) {
}
