...
AudioPlaySoundImpactItemMessage::AudioPlaySoundImpactItemMessage(ObjectID id, vec3 pos, vec3 normal, float impulse) : OnlineMessageBase(OnlineMessageCategory::LEVEL_TRANSIENT),
                                                                                                                      pos(pos),
                                                                                                                      normal(normal),
                                                                                                                      impulse(impulse) {
