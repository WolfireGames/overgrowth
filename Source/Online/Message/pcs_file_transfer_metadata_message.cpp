...
PCSFileTransferMetadataMessage::PCSFileTransferMetadataMessage(const std::string& map_name, const std::string& campaign_id) : OnlineMessageBase(OnlineMessageCategory::TRANSIENT),
                                                                                                                              map_name(map_name),
