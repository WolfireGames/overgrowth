...
const char *FZXAsset::GetLoadErrorString() {
    switch (sub_error) {
        case 0:
            return "";
        case 1:
            return "Failed to read FZX file into buffer";
        case 2:
            return "FZX file too small for header";
        case 3:
            return "FZX header is incorrect";
        case 4:
            return "FZX version incorrect";
        case 5:
            return "FZX footer incorrect";
        case 6:
            return "FZX file has unexpected file size";
        case 7:
            return "String is too long in FZX file";
        default:
