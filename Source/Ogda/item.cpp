...
Item::Item(const std::string& input_folder, const std::string& path, const std::string& type, const JobXMLParser::Item& source) : input_folder(input_folder),
                                                                                                                                  type(type),
                                                                                                                                  hash(""),
                                                                                                                                  source(source),
                                                                                                                                  only_parse(false),
...
Item::Item(const std::string& input_folder, const std::string& path, const std::string& type, const std::string& hash, const JobXMLParser::Item& source) : input_folder(input_folder),
                                                                                                                                                           type(type),
                                                                                                                                                           hash(hash),
                                                                                                                                                           source(source),
                                                                                                                                                           only_parse(false),
