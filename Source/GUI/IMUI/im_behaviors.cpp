...
IMFadeIn::IMFadeIn(uint64_t time, IMTweenType _tweener) : elapsed(0) {
    tweenType = _tweener;
 ...
 **/
IMMoveIn::IMMoveIn(uint64_t time, vec2 _offset, IMTweenType _tweener) : elapsed(0),
                                                                        targetTime(time),
                                                                        tweenType(_tweener),
                                                                        offset(_offset) {
    tweener = getTweenInstance(tweenType);
...
IMChangeTextFadeOutIn::IMChangeTextFadeOutIn(uint64_t time, std::string const& _targetText, IMTweenType _tweenerOut, IMTweenType _tweenerIn) : elapsed(0) {
...
IMChangeImageFadeOutIn::IMChangeImageFadeOutIn(uint64_t time, std::string const& _targetImage, IMTweenType _tweenerOut, IMTweenType _tweenerIn) : elapsed(0) {
    tweenerOutType = _tweenerOut;
    tweenerInType = _tweenerIn;
    tweenerOut = getTweenInstance(tweenerOutType);
    tweenerIn = getTweenInstance(tweenerInType);
...
IMMouseOverScale::IMMouseOverScale(uint64_t time, float _offset, IMTweenType _tweener) : elapsed(0),
                                                                                         targetTime(time),
                                                                                         tweenType(_tweener) {
    tweener = getTweenInstance(tweenType);
    offset = _offset;
...
IMMouseOverMove::IMMouseOverMove(uint64_t time, vec2 _offset, IMTweenType _tweener) : elapsed(0),
                                                                                      targetTime(time),
                                                                                      tweenType(_tweener),
                                                                                      offset(_offset) {
    tweener = getTweenInstance(tweenType);
 ...
 **/
IMMouseOverFadeIn::IMMouseOverFadeIn(uint64_t time, IMTweenType _tweener, float targetAlpha /*= 1.0f*/) : elapsed(0),
