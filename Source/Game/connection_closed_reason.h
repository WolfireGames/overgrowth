...
class ConnectionClosedReasonUtil {
   public:
    static std::string GetErrorMessage(ConnectionClosedReason reason) {
        switch (reason) {
            case ConnectionClosedReason::UNSPECIFIED:
                return "No error specified!";
            case ConnectionClosedReason::BAD_REQUEST:
                return "Host has received a malformed request and has closed the connection with you!";
            case ConnectionClosedReason::LOBBY_FULL:
                return "This lobby is full!";
            case ConnectionClosedReason::LOBBY_PRIVATE:
                return "This lobby is private, ask for an invite!";
            case ConnectionClosedReason::CLIENT_BANNED:
                return "You've been banned from this lobby";
            case ConnectionClosedReason::HOST_STOPPED_HOSTING:
                return "The host has stopped hosting!";
            case ConnectionClosedReason::MISSING_FILES:
                return "You are missing files, make sure to have the right mods enabled!";
            case ConnectionClosedReason::EDITOR_FORBIDDEN:
                return "You are not allowed to use the editor in this lobby!";
            case ConnectionClosedReason::CLIENT_OUTDATED:
                return "Your game version is too old, upgrade your game! Unable to join!";
            case ConnectionClosedReason::SERVER_OUTDATED:
                return "The host is playing on an older version of the game! Unable to join!";
            case ConnectionClosedReason::MOD_MISMATCH:
                return "You are not using the same mods the host is! The host has received a full list of expected mods!";
