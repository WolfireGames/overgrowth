...
void ReceiveMessage(string message) {
	...
	if(token == "level_event"){
		...
		token_iter.FindNextToken(message);
		token = token_iter.GetToken(message);
        ...
        if(token_iter.FindNextToken(message)) {
            ...
            if(token_iter.FindNextToken(message)) {
                ...
                if(token_iter.FindNextToken(message)) {
                    ...
                    Log(warning, "sound_hotspot_play_sound: Specified x and y position, but not y and z. Ignoring pos passed in");
