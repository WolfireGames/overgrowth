/*
    ...
    OpenGL loader generated by glad 0.1.35 on Mon May  2 11:27:42 2022.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.1" --generator="c" --spec="gl" --extensions="GL_AMD_debug_output,GL_ARB_debug_output,GL_ARB_depth_buffer_float,GL_ARB_fragment_program,GL_ARB_framebuffer_object,GL_ARB_instanced_arrays,GL_ARB_sample_shading,GL_ARB_seamless_cube_map,GL_ARB_seamless_cubemap_per_texture,GL_ARB_shader_texture_lod,GL_ARB_tessellation_shader,GL_ARB_texture_cube_map_array,GL_ARB_texture_float,GL_ARB_timer_query,GL_ATI_meminfo,GL_EXT_framebuffer_multisample,GL_EXT_framebuffer_object,GL_EXT_texture_compression_latc,GL_EXT_texture_compression_s3tc,GL_EXT_texture_filter_anisotropic,GL_EXT_texture_sRGB,GL_INTEL_performance_query,GL_KHR_debug,GL_NVX_gpu_memory_info,GL_NV_gpu_program4,GL_NV_vertex_program3,GL_NV_vertex_program4"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.1&extensions=GL_AMD_debug_output&extensions=GL_ARB_debug_output&extensions=GL_ARB_depth_buffer_float&extensions=GL_ARB_fragment_program&extensions=GL_ARB_framebuffer_object&extensions=GL_ARB_instanced_arrays&extensions=GL_ARB_sample_shading&extensions=GL_ARB_seamless_cube_map&extensions=GL_ARB_seamless_cubemap_per_texture&extensions=GL_ARB_shader_texture_lod&extensions=GL_ARB_tessellation_shader&extensions=GL_ARB_texture_cube_map_array&extensions=GL_ARB_texture_float&extensions=GL_ARB_timer_query&extensions=GL_ATI_meminfo&extensions=GL_EXT_framebuffer_multisample&extensions=GL_EXT_framebuffer_object&extensions=GL_EXT_texture_compression_latc&extensions=GL_EXT_texture_compression_s3tc&extensions=GL_EXT_texture_filter_anisotropic&extensions=GL_EXT_texture_sRGB&extensions=GL_INTEL_performance_query&extensions=GL_KHR_debug&extensions=GL_NVX_gpu_memory_info&extensions=GL_NV_gpu_program4&extensions=GL_NV_vertex_program3&extensions=GL_NV_vertex_program4
*/
